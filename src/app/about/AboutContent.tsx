      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
          ...
          <ScrollReveal>
            <div className="space-y-6 text-[#8BA4BC] leading-relaxed">
              <p>
                ...
                объектах абонентского доступа, магистральной и городской связи. Мы не торговый дом с цепочкой
              ...
              <p>
                ...
                стандартам <strong className="text-white">МСЭ-Т G.652.D, G.657.A1, G.657.A2 и G.655</strong>.
                Цена формируется на уровне завода, на каждую партию — паспорт качества и рефлектограмма
                по запросу.
              </p>
              <p>
        ...
        <div className="mt-16 space-y-8">
          ...
          <ProseBlock
            ...
            paragraphs={[
              "Каждая партия проходит входной контроль: соответствие стандарту МСЭ-Т, проверка затухания на 1310 и 1550 нм, контроль геометрии модового поля и радиуса изгиба, отсутствие водяного пика (для G.657.A2). По запросу — рефлектограмма, сертификаты соответствия и спецификация в PDF.",
            ]}
          />
          <ProseBlock
