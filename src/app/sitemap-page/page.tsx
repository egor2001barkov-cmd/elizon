  ...
  return (
    <>
      ...
      <ContentPageShell
        ...
        title="Карта сайта"
        subtitle="Полная структура сайта ELIZON: каталог, SEO-посадочные под популярные запросы, блог, регионы, услуги и юридические документы. Посадочные индексируются поиском и перечислены в блоке «SEO-посадочные»."
      >
