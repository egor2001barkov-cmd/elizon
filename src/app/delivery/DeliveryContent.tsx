    ...
    >
      ...
      <section>
        ...
        <p className="mt-4 text-sm text-[#8BA4BC]">
          Упаковка: заводская катушка с защитой от повреждений. Страхование груза — по запросу.
          Документы: ТОРГ-12, счёт-фактура, паспорт качества, рефлектограмма, спецификация PDF.
        </p>
      </section>
