    ...
    <>
      ...
      >
        <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
          <h2 className="font-display text-xl font-medium text-white">Корзина</h2>
          <button
            type="button"
            onClick={closeCart}
            className="flex h-11 w-11 items-center justify-center rounded-lg border border-white/10 text-[#8BA4BC] hover:text-white"
            aria-label="Закрыть"
          >
            ✕
          </button>
                ...
                >
                  <div className="flex justify-between gap-3">
                    <div>
                      ...
                      {item.km && (
                        <p className="mt-1 text-xs text-[#00D4FF]">{item.km} км</p>
                      )}
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-white hover:border-[#00D4FF]/40"
                      >
                        −
                      </button>
