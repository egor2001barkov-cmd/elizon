      ...
      {landing.type === "application" && (
        <>
          <ProseBlock
            ...
            paragraphs={[
              "Оптоволокно ELIZON используют в телекоммуникациях, FTTH, магистралях, дата-центрах, промышленности, DWDM-системах и оптических тросах дронов. Выберите сферу, близкую вашему проекту.",
            ]}
          />
          <ScrollReveal>
