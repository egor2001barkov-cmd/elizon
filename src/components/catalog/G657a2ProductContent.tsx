...
interface G657a2ProductContentProps {
  breadcrumbs: BreadcrumbItem[];
}

export function G657a2ProductContent({ breadcrumbs }: G657a2ProductContentProps) {
          ...
          <div className="grid gap-10 lg:grid-cols-[220px_1fr]">
            <aside className="hidden lg:block">
              <GlassCard hover={false} className="sticky top-28 p-4">
                <CatalogTreeNav activeCategory="optovolokno" activeSubcategory="g657" compact />
              </GlassCard>
            </aside>
            <div>
