...
export const catalogProducts: Product[] = [
  ...
  },
  {
    ...
    pricePer50Km: 120_000,
    leadTimeDays: leadTime,
    seoH1: "Волокно G.657.A1 242 мкм — катушка 50 км от 120 000 ₽",
    seoTitle: "G.657.A1 купить — катушка 50 км от 120 000 ₽ | ELIZON",
    seoDescription:
      "Купить оптоволокно G.657.A1 242 мкм: катушка 50 км от 120 000 ₽, радиус изгиба 10 мм, совместимость с G.652.D. Прямые поставки ELIZON, срок 14–21 день.",
    recommendedUse:
      "Сети доступа, городские кольца, умеренная плотность прокладки, проекты с жёстким бюджетом при требованиях G.657.",
    description:
      "Одномодовое волокно G.657.A1 с радиусом изгиба 10 мм — баланс цены и гибкости. Катушка 50 км от 120 000 ₽. Под заказ, срок 14–21 день, документы МСЭ-Т на партию.",
    highlights: [
      "Цена от 120 000 ₽ за катушку 50 км",
      "Радиус изгиба 10 мм (МСЭ-Т G.657.A1)",
      "Полная совместимость с G.652.D при сварке",
      "Для абонентского доступа и городских сетей",
      "Катушка 50 км — меньше стыков на трассе",
    ],
    specs: [
      { label: "Тип волокна", value: "G.657.A1 (нечувствительное к изгибу)" },
      { label: "Диаметр оболочки", value: "242 ± 5 мкм" },
      { label: "Диаметр модового поля", value: "≈ 9,2 мкм" },
      { label: "Минимальный радиус изгиба", value: "10 мм" },
      { label: "Затухание @ 1310 нм", value: "≤ 0,35 дБ/км" },
      { label: "Затухание @ 1550 нм", value: "≤ 0,22 дБ/км" },
      { label: "Длина на катушке", value: "50 км" },
      { label: "Цена", value: "от 120 000 ₽ / 50 км" },
      { label: "Срок поставки", value: "14–21 рабочий день" },
      { label: "Тип катушки", value: "Стандартная заводская катушка" },
      { label: "Рабочие диапазоны", value: "диапазоны O, C, L" },
      { label: "Стандарт", value: "МСЭ-Т G.657.A1" },
      { label: "Водяной пик", value: "Отсутствует" },
      { label: "Совместимость", value: "G.652.D, G.657.A2" },
    ],
  },
  {
    id: "g655-242",
