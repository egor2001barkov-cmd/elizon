...
export const flagshipProduct: Product = {
  ...
  specs: [
    { label: "Тип волокна", value: "G.657.A2 (Bend Insensitive)" },
    { label: "Диаметр оболочки", value: "242 ± 5 мкм" },
    { label: "Диаметр модового поля", value: "9,2 мкм (MFD)" },
    ...
    { label: "Тип катушки", value: "Стандартная P-drum" },
    { label: "Рабочие диапазоны", value: "O, C, L band" },
    { label: "Стандарт", value: "ITU-T G.657.A2" },
...
export const catalogProducts: Product[] = [
  ...
  },
  {
    ...
    leadTimeDays: leadTime,
    description:
      "Для длинных магистралей и DWDM. Заказываем у производителя после подтверждения.",
    highlights: [
      "Низкая дисперсия",
