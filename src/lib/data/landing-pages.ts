    ...
    sections: [
      {
        ...
        paragraphs: [
          `ELIZON поставляет G.657.A2, G.652.D, G.657.A1 и G.655 в ${cityIn} и ${region}. Прямые поставки с завода — без посредников. На каждую партию: паспорт качества, спецификация PDF, рефлектограмма по запросу.`,
