...
export const PAGE_SEO: Record<PageKey, PageSeo> = {
  home: {
    ...
    description:
      "Оптоволокно G.657.A2 242 мкм от поставщика. Катушка 50 км — от 150 000 ₽, радиус 7,5 мм. Срок 14–21 день. Телеком, FTTH, магистрали.",
    path: "/",
    titleAbsolute: true,
  ...
  applications: {
    title: "Оптоволокно по сферам применения — телеком, FTTH, магистрали",
    description:
      "Оптоволокно по сферам: телеком, FTTH, магистрали, ЦОД, промышленность, DWDM, дроны. G.657.A2 и G.652.D, срок 14–21 день.",
  ...
  about: {
    ...
    description:
      "ELIZON — поставки оптоволокна G.657.A2 с заводов. Срок 14–21 день, ITU-T, фиксация цены от 10 катушек. Москва, доставка по РФ.",
    path: ROUTES.about,
  ...
  advantages: {
    ...
    description:
      "Преимущества ELIZON: заводские цены, склад в Москве, доставка по РФ, от 150 000 ₽/50 км, гарантия и сертификаты ITU-T.",
    path: ROUTES.advantages,
    keywords: [...DEFAULT_KEYWORDS, "преимущества", "оптом", "гарантия"],
    ogImage: DEFAULT_OG_IMAGE,
  },
  services: {
    title: "Услуги — поставка, подбор волокна, OTDR-тест",
    description:
      "Услуги: поставка оптоволокна, подбор типа волокна, фиксация цены, OTDR-тест, нестандартные длины катушек.",
    path: ROUTES.services,
    keywords: [...DEFAULT_KEYWORDS, "услуги", "подбор волокна", "OTDR"],
    ogImage: DEFAULT_OG_IMAGE,
  },
  delivery: {
  ...
  sitemapPage: {
    title: "Карта сайта",
    description:
      "Карта сайта: каталог, блог, регионы, сферы применения, услуги, FAQ, юридические документы.",
  ...
  blog: {
    ...
    description:
      "Статьи: выбор G.657.A2, сравнения, монтаж, FTTH, цены, поставки. Материалы для инженеров и закупок.",
    path: ROUTES.blog,
